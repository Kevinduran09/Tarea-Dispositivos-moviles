import { IonButton, IonInput, IonTextarea, IonImg } from '@ionic/react'
...
export default function SingleNotificationForm({  formState, setFormState, handleFieldChange, onSubmit, removeField, handleAddField }: SingleNotificationFormProps) {
    return (
        <>
